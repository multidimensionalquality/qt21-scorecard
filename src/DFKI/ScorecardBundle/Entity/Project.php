...
class Project
{
     ...
     * @var integer
     *
     * @ORM\Column(name="sourceWords", type="integer")
     */
    private $sourceWords;
     ...
     * @var integer
     *
     * @ORM\Column(name="targetWords", type="integer")
     */
    private $targetWords;
     ...
     * @var string
     *
     * @ORM\Column(name="metricName", type="string", length=255)
     */
    private $metricName;
     ...
     * @var string
     *
     * @ORM\Column(name="specifications", type="text", nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="specificationsFileName", type="string", length=255, nullable=true)
     */
