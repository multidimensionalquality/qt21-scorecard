...
class Segment
{
     ...
     * @var integer
     *
     * @ORM\Column(name="originalId", type="integer", nullable=true)
     */
    private $originalId;
     ...
     * @var integer
     *
     * @ORM\Column(name="segNum", type="integer")
     */
    private $segNum;
     ...
     * @var string
     *
     * @ORM\Column(name="highlightsSource", type="text", nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="highlightsTarget", type="text", nullable=true)
     */
